    ...
    >
      <div className="w-full  md:w-3xl lg:w-5xl xl:w-7xl p-5">
        <div className="flex flex-col gap-y-5 my-5 text-center ">
          ...
          <p className="text-[16px] sm1:text-[18px]">
            {" "}
            Feel free to reach out if you'd like to collaborate or have a
            project in mind. I'm always open to new opportunities and
        ...
        >
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <div className="flex gap-x-5 sm1:gap-x-10 items-center text-white mt-2">
              <a href="https://github.com/Ramprasadya" target="_blank">
                <GithubIcon />
              </a>
              <a
                href="https://www.linkedin.com/in/ramprasad-yadav-29bba337a"
                target="_blank"
              >
                <LinkedInIcon />
              </a>

              <a href="https://www.instagram.com/iamyadavram" target="_blank">
                <InstagramIcon />
              </a>
            </div>
          </div>
