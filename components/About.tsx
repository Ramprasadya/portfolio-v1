...
const About = () => {
  ...
  return (
    <div
      ref={aboutRef}
      className="md:h-screen w-full py-10 md:py-0 justify-center items-center flex flex-col bg-[#000e25] text-white overflow-hidden"
    >
      ...
      <div className="w-full flex flex-col justify-center items-center gap-y-4 text-center">
        <h1 className="text-4xl josefin font-bold">About Me</h1>
        <p className="text-[18px] ">I specialize in JavaScript-based technologies such as React, Next.js, TypeScript, Tailwind CSS, Node.js, 
...
applications that are both intuitive and performant.</p>
      ...
      <div className="flex gap-5 flex-wrap mt-5 text-center justify-center ">
